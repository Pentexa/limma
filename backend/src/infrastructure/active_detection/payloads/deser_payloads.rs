...
pub fn get_java_payloads() -> Vec<PayloadDefinition> {
    vec![
        PayloadDefinition {
            ...
            expected_indicator: ExpectedIndicator::ErrorPattern("java.io.InvalidClassException".to_string()),
        ...
        PayloadDefinition {
            ...
            expected_indicator: ExpectedIndicator::ErrorPattern("java.io.StreamCorruptedException".to_string()),
            severity: SeverityLevel::Critical,
            safe_for_production: true,
        },
    ]
...
pub fn get_php_payloads() -> Vec<PayloadDefinition> {
    vec![
        PayloadDefinition {
            ...
            expected_indicator: ExpectedIndicator::ErrorPattern("PHP Notice:  unserialize()".to_string()),
            severity: SeverityLevel::Critical,
            safe_for_production: true,
        },
        PayloadDefinition {
            ...
            expected_indicator: ExpectedIndicator::ErrorPattern("unserialize(): Error at offset".to_string()),
            severity: SeverityLevel::Critical,
            safe_for_production: true,
        },
    ]
...
pub fn get_python_payloads() -> Vec<PayloadDefinition> {
    vec![
        PayloadDefinition {
            id: Uuid::new_v4().to_string(),
            payload: "gASVKQAAAAAAAACMBXBvc2l4lIwGc3lzdGVtlJOUjBFlY2hvICdwaWNrbGVfdGVzdCculIWUUpQu".to_string(),
            description: "Python Pickle: Base64 encoded echo command".to_string(),
            expected_indicator: ExpectedIndicator::ErrorPattern("pickle.UnpicklingError".to_string()),
            severity: SeverityLevel::Critical,
