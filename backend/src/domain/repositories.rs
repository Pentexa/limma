...
pub trait SettingsRepository: Send + Sync {
    async fn get_all_profiles(&self) -> Result<Vec<crate::domain::entities::SettingsProfile>, String>;
    async fn get_profile(&self, id: &str) -> Result<Option<crate::domain::entities::SettingsProfile>, String>;
    async fn save_profile(&self, profile: crate::domain::entities::SettingsProfile) -> Result<(), String>;
...
pub trait ActiveScanRepository: Send + Sync {
    async fn create_scan(&self, scan: crate::domain::active_vuln::ActiveScanResult) -> Result<(), String>;
    async fn update_status(&self, scan_id: uuid::Uuid, status: crate::domain::active_vuln::ActiveScanStatus) -> Result<(), String>;
    async fn find_by_id(&self, scan_id: uuid::Uuid) -> Result<Option<crate::domain::active_vuln::ActiveScanResult>, String>;
    async fn list_scans(&self, filters: &crate::domain::active_vuln::ScanQueryParams) -> Result<Vec<crate::domain::active_vuln::ActiveScanResult>, String>;
    async fn delete_scan(&self, scan_id: uuid::Uuid) -> Result<(), String>;
    #[allow(dead_code)]
    async fn update_scan(&self, scan: crate::domain::active_vuln::ActiveScanResult) -> Result<(), String>;
}

#[async_trait]
pub trait ActiveFindingRepository: Send + Sync {
    async fn save_finding(&self, finding: crate::domain::active_vuln::ActiveVulnFinding) -> Result<(), String>;
    async fn find_by_id(&self, finding_id: uuid::Uuid) -> Result<Option<crate::domain::active_vuln::ActiveVulnFinding>, String>;
    async fn find_by_scan_id(&self, scan_id: uuid::Uuid) -> Result<Vec<crate::domain::active_vuln::ActiveVulnFinding>, String>;
    async fn update_poc_id(&self, finding_id: uuid::Uuid, poc_id: uuid::Uuid) -> Result<(), String>;
    async fn find_by_filters(&self, params: &crate::domain::active_vuln::ActiveFindingQueryParams) -> Result<Vec<crate::domain::active_vuln::ActiveVulnFinding>, String>;
